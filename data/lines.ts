...
export default {
  ...
  roma: {
    ...
    steps: [
      ['Paris Austerlitz', h(20, 0), true],
      ['Dijon', h(22, 40), false],
      ['Lyon Part-dieu', h(0, 30), false],
      ['Frontière FR-IT', h(2, 0), false],
      ['Genova', h(4, 0), false],
      ['Firenze Campo di Marte', h(6, 20), true],
      ['Roma Termini', h(9, 0), true],
    ],
  },
  romagv: {
    ...
    train: Trains.talgo250,
    steps: [
      ['Paris Gare de Lyon', h(21, 0), true],
      ['Lyon Part-dieu', h(23, 30), false],
      ['Frontière FR-IT', h(1, 0), false],
      ['Torino Lingotto', h(2, 0), false],
      ['Milano Porta Garibaldi', h(4, 0), false],
      ['Bologna Centrale', h(5, 30), false],
      ['Firenze Campo di Marte', h(6, 20), true],
      ['Direttissima', h(7, 40), false],
      ['Roma Termini', h(8, 0), true],
      ['Napoli Centrale', h(9, 15), true],
    ],
  },
  romagvit: {
